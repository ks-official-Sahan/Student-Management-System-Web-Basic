...
?>
    ...
    <head>
        <title>CJ Academy | Teacher Panel | Add Lecture Notes</title>
                ...
                <div class="col-12">
                    ...
                    <div class="row r1">
                        <div class="col-12">
                            ...
                            <h3 class="text-black-50 fst-itali text-center mb-5">Teacher Panel | Add Lecture Notes</h3>
                        </div>
                    </div>
                    ...
                    <div class="row div4">
                                        ...
                                        <div class="nav flex-column nav-pills me-3 mt-3 " role="tablist" aria-orientation="vertical">
                                            <nav class="nav flex-column ">
                                                ...
                                                <nav class="nav nav-pills nav-fill px-2">
                                                    <a class="nav-link active bg-success " href="#">Add Lecture Notes</a>
                                                </nav>
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-12">
                                            ...
                                            <div class="row my-2 mb-lg-4">
                                                <div class="col-4">
                                                    <p class="fs-5 text-dark text-start">Topic</p>
                                                </div>
                                                <div class="col-8">
                                                    <input type="text" id="topic" class="form-control text-black-50 fs-5 text-center" placeholder="Type the Topic of the note" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row my-2">
                                                <div class="col-8 offset-2 col-lg-4 ms-lg-3 mt-lg-5">
                                                    <div class="row d-grid">
                                                        <button class="btn btn-success" onclick="uploadpdf2();">Upload</button>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-12 col-lg-2 px-5 mt-md-5 mt-3" style="margin-bottom: 35px;">
                            ...
                            <div class="row d-grid rbutton1">
                                <button class="btn btn-success my-2 disabled">Add Lecture Notes</button>
                            </div>
