                ...
                <div class="col-12">
                    ...
                    <div class="row r1">
                        <div class="col-12">
                            ...
                            <h3 class="text-black-50 fst-itali text-center mb-5">Student Area </h3>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8 col-12 rpanalbody border border-5 ">
                            ...
                            <div class="row pe-lg-5 ">
                                        ...
                                        <div class="nav flex-column nav-pills me-3 mt-3 " role="tablist" aria-orientation="vertical">
                                            <nav class="nav flex-column ">
                                                ...
                                                <nav class="nav nav-pills nav-fill px-2">
                                                    <a class="nav-link link-danger active bg-primary" aria-current="page" href="teacherRegistation.php">Verified Student </a>
                                ...
                                <div class="col-12 col-md-8">
                                    <p class="fs-5 fw-bold text-danger text-start mt-lg-3">Trail period will expire after: <?php
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-12">
                                            ...
                                            <div class="row my-2">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" class="form-control text-black-50 fs-5 text-center" disabled placeholder="Type the grade" id="nic" />
                                                </div>
                                            </div>
