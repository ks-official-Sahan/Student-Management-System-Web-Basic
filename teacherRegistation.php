                            ...
                            <div class="row pe-lg-5 ">
                                        ...
                                        <div class="nav flex-column nav-pills me-3 mt-3 " role="tablist" aria-orientation="vertical">
                                            <nav class="nav flex-column ">
                                                ...
                                                <nav class="nav nav-pills nav-fill px-2">
                                                    <a class="nav-link active bg-success" aria-current="page" href="#">Teachers Registation</a>
                                ...
                                <div class="col-12 col-lg-6 div5 mt-5 mb-2">
                                    ...
                                    <div class="row my-2">
                                        ...
                                        <div class="col-8">
                                            <input type="number" class="form-control text-black-50 fs-5 text-center" placeholder="Type the mobile" id="mobile" />
                                        </div>
                                    </div>
                                ...
                                <div class="col-12  col-lg-6 ">
                                    ...
                                    <div class="row rb1">
                                        ...
                                        <div class="col-10 offset-1 col-md-6  d-grid">
                                            <button class="btn btn-danger text-center" onclick="teacherReg();">Register</button>
                                        </div>
