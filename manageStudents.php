...
?>
    ...
    <head>
        <title>CJ Academy|Students Managing Area</title>
                ...
                <div class="col-12">
                    ...
                    <div class="row r1">
                        <div class="col-12">
                            ...
                            <h3 class="text-black-50 fst-itali text-center mb-5">Admin Panel | Students Managing Area</h3>
                        </div>
                    </div>
                    ...
                    <div class="row div4">
                                        ...
                                        <div class="nav flex-column nav-pills me-3 mt-3 " role="tablist" aria-orientation="vertical">
                                            <nav class="nav flex-column ">
                                                ...
                                                <nav class="nav nav-pills nav-fill px-2">
                                                    <a class="nav-link active bg-danger " href="#">Manage Students</a>
                                                </nav>
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="row mt-5">
                                        <div class="col-12">
                                            ...
                                            <div class="row my-2">
                                                <div class="col-4">
                                                    <p class="fs-5 text-dark text-start">Select a student</p>
                                                </div>
                                                <div class="col-8">
                                                    <select class="form-select text-black-50 fs-5 text-center" id="id" onchange='getDp("student");'>
                                            ...
                                            <div class="row my-2">
                                                <div class="col-4">
                                                    <p class="fs-5 text-dark text-start">Payment Status</p>
                                                </div>
                                                <div class="col-8">
                                                    <input type="text" id="payment" class="form-control text-black-50 fs-5 text-center" placeholder="Payment status" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row my-2">
                                                <div class="col-8 offset-2 col-lg-4 ms-lg-3 mt-lg-3">
                                                    <div class="row d-grid">
                                                        <button class="btn btn-success" onclick="studentsUpdateByAdmin();">Update</button>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-12 col-lg-2 px-5 mt-md-5 mt-3">
                            ...
                            <div class="row d-grid rbutton1">
                                <button class="btn btn-danger my-2 disabled">Students</button>
                            </div>
                            <div class="row d-grid rbutton">
