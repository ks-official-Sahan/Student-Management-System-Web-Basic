                ...
                <div class="col-12">
                    ...
                    <div class="row r1">
                        <div class="col-12">
                            ...
                            <h3 class="text-black-50 fst-itali text-center mb-5">Academic Officer Area </h3>
                        </div>
                    </div>
                                        ...
                                        <div class="nav flex-column nav-pills me-3 mt-3 " role="tablist" aria-orientation="vertical">
                                            <nav class="nav flex-column ">
                                                ...
                                                <nav class="nav nav-pills nav-fill px-2">
                                                    <a class="nav-link link-danger active bg-primary" aria-current="page" href="teacherRegistation.php">Academic Officer Profile</a>
